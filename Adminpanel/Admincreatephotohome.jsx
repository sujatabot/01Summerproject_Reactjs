...
import { useCreateHomePhoto, useGetHomePhotos, useDeleteHomePhoto } from '../src/api/homephotoapi/Homepageapi';

const Admincreatephotohome = () => {
  const [title, setTitle] = useState('');
  const [file, setFile] = useState(null);
  const { mutate: createPhoto, isLoading: isCreating, isError: isCreateError, error: createError } = useCreateHomePhoto();
  const { data: photos, isLoading: isPhotosLoading, isError: isPhotosError, error: photosError } = useGetHomePhotos();
